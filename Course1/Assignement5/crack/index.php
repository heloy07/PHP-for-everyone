<!DOCTYPE html>
<head><title>Heloy Estevanin MD5 Cracker</title></head>
<body>
<h1>MD5 cracker</h1>
...
if (isset($_GET['md5'])) {
	...
	for ($i = 0; $i < strlen($txt); $i++) {
		...
		// Our second loop Not the use of new variables
		// $j and $ch2
		for ($j = 0; $j < strlen($txt); $j++) {
			$ch2 = $txt[$j]; // Our second character

			// Our third loop Not the use of new variables
			// $k and $ch3
			for ($k = 0; $k < strlen($txt); $k++) {
				$ch3 = $txt[$k];
				// Our fourth loop Not the use of new variables
				// $l and $ch4
				for ($l = 0; $l < strlen($txt); $l++) {
					$ch4 = $txt[$l];

					// Concatenate the 4 characters together to
